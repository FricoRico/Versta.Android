...
object SettingsDefaults {
    ...
    fun colorsInverted(
        ...
        leadingIconColor: Color = MaterialTheme.colorScheme.inverseOnSurface.lighten(0.2f),
        overlineColor: Color = MaterialTheme.colorScheme.inverseOnSurface.lighten(0.2f),
        supportingColor: Color = MaterialTheme.colorScheme.inverseOnSurface.lighten(0.2f),
        trailingIconColor: Color = MaterialTheme.colorScheme.inverseOnSurface.lighten(0.2f),
